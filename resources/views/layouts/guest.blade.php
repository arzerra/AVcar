...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-100 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-cover bg-center"
            ...
            <div class="-mt-32">
                <a href="/">
                    <x-loginregister-logo class="w-20 h-20 fill-current text-gray-500" />
                </a>
            </div>

            <!-- Updated form container with a dark style -->
            <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-black text-gray-900 shadow-lg rounded-lg border border-gray-700">
                {{ $slot }}
            </div>
        </div>
    </body>
