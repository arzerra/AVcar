        ...
        <header class="bg-black shadow-lg">
            <nav class="flex items-center justify-between px-8 py-4">
                <div class="flex items-center">
                    <a class="text-lg px-2 py-1"></a>
                    <img src="{{ asset('images/av.png') }}" width="200" alt="AV Logo" />
                </div>
                <div class="flex-grow flex items-center justify-center space-x-6 -ml-4">
                    <a href="{{ route('dashboard') }}" class="text-white text-lg px-4 py-2 rounded-md hover:bg-gray-700 transition duration-300">
                        Home
                    </a>
                    <a href="{{ route('dashboard') }}" class="text-white text-lg px-4 py-2 rounded-md hover:bg-gray-700 transition duration-300">
                        Cars
