...
<x-app-layout>
    ...
    <div class="py-3">
                    ...
                    <div class="flex mb-4 justify-center">
                        <button id="inventoryBtn" class="toggle-button text-white text-2xl font-bold py-2 px-4 rounded-l-lg bg-transparent border border-gray-400 dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 focus:outline-none">
                            Inventory
                        </button>
                        <button id="stocksBtn" class="toggle-button text-white text-2xl font-bold py-2 px-4 rounded-r-lg bg-transparent border border-gray-400 dark:border-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 focus:outline-none">
                            Stocks
                        </button>
                    </div>
                                    ...
                                    @foreach ($cars as $car)
                                        <tr>
                                            ...
                                            @if($car->carStatus == 'rented')
                                                text-red-500
                                            @elseif($car->carStatus == 'available')
                                                text-green-500
                                            @endif">
