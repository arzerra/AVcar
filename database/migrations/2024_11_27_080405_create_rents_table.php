...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('rents', function (Blueprint $table) {
            ...
            $table->string('carLicense'); // Add carLicense column
            $table->decimal('carPrice', 10, 2); // Add carPrice column
            ...
            $table->enum('rentStatus', ['pending', 'rented', 'declined', 'cancelled'])->default('pending');
